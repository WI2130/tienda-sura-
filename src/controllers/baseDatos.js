...
let productos=[
    ...
    },
    {
        ...
        precio:15000000,
        popularidad:5,
        descripcion:"El palo de Campeche (Haematoxylum campechianum), o palo de tinte, es un árbol de la familia de las leguminosas. Es nativo de Mesoamérica, particularmente de la península de Yucatán y en especial del estado de Campeche, de Guatemala y Belice.El nombre de la especie quiere decir “madera que sangra” (haima en griego es sangre y xylon, madera). La madera se usa para extraer hematoxilin que es un colorante. También se usa para leña y para postes. Las hojas y ramas se usan como forraje. Las flores producen miel. Debido a sus flores atractivas se le usa como ornato alrededor de las casas.Es un árbol que llega a medir 6 metros de altura. Las hojas de 3-6 cm de largo son alternas, perennes, crasas y obtusas por su base. Las flores tienen cinco pétalos y corola blanca que se juntan en cimas sujetas por un pedúnculo. El fruto es una drupa de 1 cm de largo."
    },
    {
    ...
    {
        nombre:"Bonsai de Sauce",
        fotos:["https://firebasestorage.googleapis.com/v0/b/tiendasurafaha.appspot.com/o/bonsai%2311.jpg?alt=media&token=d70a5c7b-bc40-4258-a442-d4a5c435e8a3","https://firebasestorage.googleapis.com/v0/b/tiendasurafaha.appspot.com/o/bonsai%2312.jpg?alt=media&token=feaad4bf-cb86-4ca2-b2ea-eb92233fc91c"],
        precio:6000000,
        popularidad:4,
        descripcion:"Sauce     (Salix babylonica)  El tipo más conocido de sauce es el sauce llorón, con sus largas arrastran ramas que forman un dosel de paraguas perdido casi todo el camino hasta el suelo. Dentro del amplio conjunto de plantas leñosas de entre los que conocemos al sauce llorón, debemos decir que es uno de los más atractivos"
    },
    {
        nombre:"Bonsai de Kingsville",
    ...
    {
        nombre:"Bonsai de Junipero",
        fotos:["https://firebasestorage.googleapis.com/v0/b/tiendasurafaha.appspot.com/o/bonsai%2315.jpg?alt=media&token=c99df205-6486-4863-85e6-19d487316279","https://firebasestorage.googleapis.com/v0/b/tiendasurafaha.appspot.com/o/bonsai%2316.jpg?alt=media&token=b5ae5b84-2316-4ecd-afa2-d6ac91887be4"],
        precio:4000000,
        popularidad:5,
        descripcion:"Juniperus squamata, es una especie arbórea de la familia de las coníferas (división Pinophyta).Nativo del Himalaya, China, nordeste de Afganistán, este a oeste de Yunnan en el sudoeste de China, y con subpoblaciones aisladas en el norte al oeste de Gansu, y este de Fujian. Crece a altitudes de 1.600-4.900 msnm. El Juniperus es un género de más de treinta especies de coníferas arbustivas muy populares y adecuadas para ser utilizadas como Bonsai. La especie clásica es el ‘enebro chino’ (Juniperus chinensis), también populares son: Juniperus Squamata, Sargentii, Sabina, Rigida y Communis. La gama de colores de follaje oscila entre los verdes con tonos azul oscuro y los verdes claros. Estos árboles son muy adecuados para la creación de madera muerta (jin y shari).Situación: coloque el árbol en el exterior, durante todo el año, en un lugar donde reciba una gran cantidad de luz solar. Los enebros no crecen bien en el interior. Durante el invierno debe protegerse el árbol cuando las temperaturas caen por debajo de -10 grados C."
    },
    {
        nombre:"onsai de Junipero",
        fotos:["https://firebasestorage.googleapis.com/v0/b/tiendasurafaha.appspot.com/o/bonsai%2317.jpg?alt=media&token=40056266-1e9d-43fd-9b38-905965f130de","https://firebasestorage.googleapis.com/v0/b/tiendasurafaha.appspot.com/o/bonsai%2318.jpg?alt=media&token=02a258a4-032d-4760-9a6b-627eb4846cb4"],
        precio:3800000,
        popularidad:5,
        descripcion:"Juniperus Chinensis variedad Itoigawa, es una especie arbórea de la familia de las coníferas (división Pinophyta). El junípero chinensis Itoigawa es uno de los árboles más valorados como bonsái debido a la densidad de su follaje, lo que lo hace especialmente indicado para crear diseños con volúmenes espectaculares.El Junípero es un género de alrededor de 50-70 especies dentro de la familia Ciprés.Son coníferas de hoja perenne en forma de árboles o arbustos, que son muy populares para los propósitos del Bonsái. Las especies más populares son el Junípero Chino (Juniperus Chinensis), Shimpaku Japonés (Juniperus Sargentii) y el Sonare (Juniperus procumbens). Estas especies presentan guías de cuidado similares.Los colores del follaje oscilan entre azules-verdes oscuros a verdes claros, y el follaje puede tener tanto forma de escamas, como de agujas. Los Juníperos de escama suelen tener un follaje en forma de aguja cuando son jóvenes (se le llama follaje juvenil), y el follaje típico en forma de escama aparece más tarde. Después de una poda o doblado fuertes, de un riego excesivo o de cualquier otro tipo de estrés, a menudo aparecerá de nuevo el follaje juvenil. Puede tardar unos pocos años hasta que el suficiente follaje en forma de escama haya crecido por completo y entonces se pueda eliminar todo el follaje en forma de aguja.Los conos en forma de baya son redondos u ovalados, dependiendo de la especie miden alrededor de 2cm (1 pulgada), o en ocasiones solo 3mm; y necesitan uno o dos años para madurar. Las semillas son redondas o con filos. Los conos a menudo se los comen las aves que esparcen a su vez las semillas germinables con sus excrementos.Los Juníperos son muy apropiados para crear madera muerta (Jin y Shari). Esto se debe a que las venas vivas debajo de una rama rota, o por cualquier otra razón moribunda, se secarán y morirán. Esto se traduce en una madera muerta natural que es pelada, pulida y blanqueada por las condiciones climáticas y que es muy duradera en el caso de los Juníperos. La tríada de follaje verde, corteza color rojo-marrón o amarillo-marrón y madera muerta de color blanco plateado es muy atrayente."
    },
    {
        nombre:"Bonsai de Premna",
        fotos:["https://firebasestorage.googleapis.com/v0/b/tiendasurafaha.appspot.com/o/bonsai%2319.jpg?alt=media&token=8aa38a55-361c-409d-8d3f-36d5787f0891","https://firebasestorage.googleapis.com/v0/b/tiendasurafaha.appspot.com/o/bonsai%2320.jpg?alt=media&token=3d58f241-a6b7-4b0c-bc98-4dca6363d4bd"],
        precio:300000,
        popularidad:4,
        descripcion:"Premna.Nombre científico.Premna Microphylla.Família Lamiáseas.Origen Planta subtropical proveniente de Indonesia, Malasia, Filipinas y Taiwan. Características Tronco de color crema claro. Por lo general retorcido. Hojas simples, alargadas, ligeramente ovaladas y de color verde intenso. Flores blancas, pequeñas y en racimo. Sus raíces son muy interesantes y fuertes, pudiéndose trabajar en estilo de “raíces expuestas”. Situación Deben situarse en el exterior, protegiéndolo del calor extremo del verano. Lo ideal es colocarlo en un lugar donde reciba el sol de la mañana y que esté protegido del calor del medio día. En el invierno debemos protegerlo ante las heladas."
    }
